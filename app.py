...
with c2:
    ...
    sex_df_plot = pd.DataFrame({"Sexo": ['Feminino', 'Masculino'], "Total": [total_fem, total_masc]})
...
fig_demo = px.bar(demo_df, x="Faixa Etária", y="Óbitos", color="Causa", barmode="group",import streamlit as st
import pandas as pd
import plotly.express as px
import plotly.graph_objects as go
